...
cmd = (
    "echo === log ===; tail -30 /tmp/easyocr_slidevqa.log 2>&1\n"
    f"echo === ocr file ===; ls -la {root}/sota_text_ocr 2>&1\n"
    "echo === procs ===; ps -ef | grep -E 'easyocr|extract_visdom_ocr' | grep -v grep\n"
